...
const ListCars = () => {
  ...
  const queryCountCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/countCars`,
        {
          headers: {
  ...
  const queryListCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/getAllCar?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  return (
    <div className="listCars">
      ...
      <div className="carsFilter">
        <div
          className={pathname === "/admin/cars/all" ? activeDiv : div}
          onClick={() => navigate("/admin/cars/all")}
        >
          <p>Tất cả</p>
        ...
        |
        <div
          className={pathname === "/admin/cars/approved" ? activeDiv : div}
          onClick={() => navigate("/admin/cars/approved")}
        >
          <p>Đã duyệt</p>
        ...
        |
        <div
          className={pathname === "/admin/cars/pending" ? activeDiv : div}
          onClick={() => navigate("/admin/cars/pending")}
        >
          <p>Chưa duyệt</p>
                ...
                return (
                  ...
                  >
                    ...
                    <p
                      className="brand"
                      onClick={() =>
                        navigate(`/admin/cars/carsByBrand/all/${car.brand}`)
                      }
                    >
                      {car.brand}
                    </p>
                    <p
                      ...
                      onClick={() =>
                        navigate(
                          `/admin/cars/carsByState/all/${getStateName(
                            car.state
                          )}`
                        )
                      }
                    ...
                    <div className="provider">
                      ...
                      <h5
                        onClick={() =>
                          navigate(
                            `/admin/cars/carsByProvider/all/${car.idProvider._id}`
                          )
                        }
                      >
                        {car.idProvider.username}
                      </h5>
                    </div>
                    <div className="time">
