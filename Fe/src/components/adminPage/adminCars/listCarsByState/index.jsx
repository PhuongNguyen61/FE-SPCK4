...
const ListCarsByState = () => {
  ...
  const queryCountCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/countCarsByState/${splitPathname[5]}`,
        {
          headers: {
  ...
  const queryListCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/carByState?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}&state=${splitPathname[5]}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  return (
    <div className="listCarsByState">
      ...
      <div className="carsFilter">
        <div
          className={
            pathname === `/admin/cars/carsByState/all/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByState/all/${splitPathname[5]}`)
          }
        >
          <p>Tất cả</p>
        ...
        <div
          className={
            pathname === `/admin/cars/carsByState/approved/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByState/approved/${splitPathname[5]}`)
          }
        >
          <p>Đã duyệt</p>
        ...
        <div
          className={
            pathname === `/admin/cars/carsByState/pending/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByState/pending/${splitPathname[5]}`)
          }
        >
          <p>Chưa duyệt</p>
