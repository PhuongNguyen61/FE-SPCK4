    ...
    return (
        <div className='listCarsByProvider'>
            ...
            <div className='carsFilter'>
                <div className={pathname === `/admin/cars/carsByProvider/all/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByProvider/all/${splitPathname[5]}`)}>
                    <p>Tất cả</p>
                    <p>({totalCars ? totalCars : 0})</p>
                </div>
                |
                <div className={pathname === `/admin/cars/carsByProvider/approved/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByProvider/approved/${splitPathname[5]}`)}>
                    <p>Đã duyệt</p>
                    <p>({approvedCars ? approvedCars : 0})</p>
                </div>
                |
                <div className={pathname === `/admin/cars/carsByProvider/pending/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByProvider/pending/${splitPathname[5]}`)}>
                    <p>Chưa duyệt</p>
