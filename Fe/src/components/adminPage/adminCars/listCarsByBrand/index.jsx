...
const ListCarsByBrand = () => {
  ...
  const queryCountCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/countCarsByBrand/${splitPathname[5]}`,
        {
          headers: {
  ...
  const queryListCars = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/cars/carByBrand?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}&brand=${splitPathname[5]}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  return (
    <div className="listCarsByBrand">
      <div className="head">
        <h3>Xe theo hãng: {splitPathname[5]}</h3>
        {/* <h5>Xem</h5> */}
      </div>
      <div className="carsFilter">
        <div
          className={
            pathname === `/admin/cars/carsByBrand/all/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByBrand/all/${splitPathname[5]}`)
          }
        >
          <p>Tất cả</p>
        ...
        <div
          className={
            pathname === `/admin/cars/carsByBrand/approved/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByBrand/approved/${splitPathname[5]}`)
          }
        >
          <p>Đã duyệt</p>
        ...
        <div
          className={
            pathname === `/admin/cars/carsByBrand/pending/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/cars/carsByBrand/pending/${splitPathname[5]}`)
          }
        >
          <p>Chưa duyệt</p>
...
export default ListCarsByBrand;
