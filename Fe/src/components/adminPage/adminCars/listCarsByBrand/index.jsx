    ...
    return (
        <div className='listCarsByBrand'>
            ...
            <div className='carsFilter'>
                <div className={pathname === `/admin/cars/carsByBrand/all/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByBrand/all/${splitPathname[5]}`)}>
                    <p>Tất cả</p>
                    <p>({totalCars ? totalCars : 0})</p>
                </div>
                |
                <div className={pathname === `/admin/cars/carsByBrand/approved/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByBrand/approved/${splitPathname[5]}`)}>
                    <p>Đã duyệt</p>
                    <p>({approvedCars ? approvedCars : 0})</p>
                </div>
                |
                <div className={pathname === `/admin/cars/carsByBrand/pending/${splitPathname[5]}` ? activeDiv : div} onClick={() => navigate(`/admin/cars/carsByBrand/pending/${splitPathname[5]}`)}>
                    <p>Chưa duyệt</p>
