...
const ListCommentsByNews = () => {
  ...
  const queryCountComments = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/comments/countCommentsByNews/${splitPathname[5]}`,
        {
          headers: {
  ...
  const queryListComments = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/comments/commentByNewsId?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}&newsId=${splitPathname[5]}`
      );
  ...
  return (
    <div className="listCommentsByNews">
      <div className="head">
        ...
        <h5 onClick={() => navigate(`/news/details/${splitPathname[5]}`)}>
          Xem bài viết
        </h5>
      </div>
      <div className="commentsFilter">
        <div
          className={
            pathname ===
            `/admin/comments/commentsByNews/all/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/comments/commentsByNews/all/${splitPathname[5]}`)
          }
        >
          <p>Tất cả</p>
        ...
        <div
          className={
            pathname ===
            `/admin/comments/commentsByNews/approved/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
        ...
        <div
          className={
            pathname ===
            `/admin/comments/commentsByNews/spam/${splitPathname[5]}`
              ? activeDiv
              : div
          }
          onClick={() =>
            navigate(`/admin/comments/commentsByNews/spam/${splitPathname[5]}`)
          }
        >
          <p>Bình luận rác</p>
