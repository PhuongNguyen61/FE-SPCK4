...
const ListNews = () => {
  ...
  const queryCountNews = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/news/countNews`,
        {
          headers: {
  ...
  const queryListNews = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/v1/news?limit=${limit}&currentPage=${currentPage}&isStatus=${isStatus}`,
        {
          headers: {
            Authorization: `Bearer ${accessToken}`,
          },
  ...
  return (
    <div className="listNews">
      ...
      <div className="newsFilter">
        <div
          className={pathname === "/admin/news/all" ? activeDiv : div}
          onClick={() => navigate("/admin/news/all")}
        >
          <p>Tất cả</p>
        ...
        |
        <div
          className={pathname === "/admin/news/published" ? activeDiv : div}
          onClick={() => navigate("/admin/news/published")}
        >
          <p>Đã xuất bản</p>
        ...
        |
        <div
          className={pathname === "/admin/news/draft" ? activeDiv : div}
          onClick={() => navigate("/admin/news/draft")}
        >
          <p>Bản nháp</p>
                ...
                return (
                  ...
                  >
                    ...
                    <p
                      ...
                      onClick={() =>
                        navigate(
                          `/admin/news/newsByCategory/all/${news.isCategory}`
                        )
                      }
                    >
                      {getCategoryName(news.isCategory)}
                    </p>
                    <div className="time">
